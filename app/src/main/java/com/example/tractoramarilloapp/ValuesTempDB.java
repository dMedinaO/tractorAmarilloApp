...
public class ValuesTempDB {
    ...
    public void addElements(Context context){
        ...
        handlerDBPersistence.saveUsuario(new UserSession("24858868", "REtcheverry", "28858868-3", "2"));
        handlerDBPersistence.saveUsuario(new UserSession("17609672", "LRojas", "17609672-1", "1"));

        //MAQUINARIA
        handlerDBPersistence.saveMaquina(new Maquinaria("maquina2", "patito", "patito", "2019", "0", "---", "BLACK", "124ra"));
        handlerDBPersistence.saveMaquina(new Maquinaria("m123", "patito2", "patito2", "2018", "0", "---", "BLACK", "aqse"));
